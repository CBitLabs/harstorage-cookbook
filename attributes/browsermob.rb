...
default['harstorage']['browsermob']['download-location'] = "#{node['harstorage']['browsermob']['install-directory']}/browsermob-proxy.deb"
default['harstorage']['browsermob']['jre-package'] = 'default-jre'

default['harstorage']['browsermob']['supervisor']['command'] = '/usr/local/bin/browsermob-proxy --port=9090'
